...
import { listAllAttempts, type AdminAttempt } from "../../api/admin";
  ...
  return (
    <section>
      <div className="flex flex-wrap items-end justify-between gap-4">
        <h2 className="font-display text-lg font-semibold text-text">Org-wide reports</h2>
      ...
      {error && (
        <p role="alert" className="mt-6 font-body text-sm text-red-300">{error}</p>
      )}
